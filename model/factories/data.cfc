component accessors=true {
	...
	public any function init( fw, udfService ) {
		variables.fw = arguments.fw;
		variables.udfService = arguments.udfService;
	...
	private struct function getPropertyMetadata( prop ) {
		...
		if ( structKeyExists(prop,"cfsqltype") ) {
			...
			metadata.displayname = ( structKeyExists(prop,"displayname") ? prop.displayname : variables.udfService.upperFirst(prop.name) );
